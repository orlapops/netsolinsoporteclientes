...
@Component({
    selector: 'kendo-grid-editarch-form',
    styles: [
        'input[type=text] { width: 100%; }'
      ],
      templateUrl: "./edit-formarch.Soporte.component.html",
  })

export class GridEditFormarchComponent  implements OnInit, HttpInterceptor {
    public active = false;
